...
export const answerAsk: MetaTool = {
  definition: {
    name: ANSWER_ASK,
    description:
      "Called by Graft's ask card with the person's click, on a chat product that renders the card: records the person's answer to acquire's build approval, request_connection's confirmation or its scope ask, the same record the console's answer makes. " +
